...
| 4 Results and Discussion | `04_results.tex` | **0** | ✅ **done 2026-08-03 night.** The chapter was re-derived from the CSVs rather than edited, so the 44 em dashes went with the old prose. Verified 0 em dashes, 0 unicode dashes, 0 AI-vocabulary hits; two negative parallelisms found and rewritten |
