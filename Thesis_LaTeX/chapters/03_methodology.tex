...
\begin{draftnote}
Ported from \texttt{Thesis\_Documentation/Methods\_Chapter\_Layer1.md} (draft 2026-07-19), which is
now frozen as a dated record --- this \texttt{.tex} is the source of truth. Numbers verified
against \texttt{ur5\_grasp/} source on 2026-07-19. \textbf{Open:} this draft predates the Day-23
audit; check whether it narrates the withdrawal, since Section~\ref{sec:r-validity} of the
Results chapter assumes it does.
\end{draftnote}
